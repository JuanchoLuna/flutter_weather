  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      margin: const EdgeInsets.symmetric(
        horizontal: WEATHERSpacing.lg * 2,
        vertical: WEATHERSpacing.xs,
      ),
      width: WEATHERSpacing.spaceUnit * 100,
      height: WEATHERSpacing.xxlg,
      decoration: BoxDecoration(
        ...
        borderRadius: const BorderRadius.all(
          Radius.circular(WEATHERSpacing.xxs * 5),
        ),
      ),
      child: Center(
        child: Text(
          ...
          style: theme.textTheme.labelLarge?.copyWith(
            ...
            color: textColor ?? WEATHERColors.black,
          ),
        ),
      ),
    );
